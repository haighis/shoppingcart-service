...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "shoppingcartservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "shoppingcartservice API";

        private String description = "shoppingcartservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "shoppingcartservice";
